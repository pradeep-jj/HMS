...
public class DoctorDao {
    ...
    public boolean registerDoctor(Doctor d) {
        ...
        try {
            ...
            ps.setString(2, d.getDob()); // Consider changing this to Date if dob is a date in DB
       ...
       Doctor d = null;
    	try {
            ...
            while (rs.next()) {
                ...
                d.setDob(rs.getString("dob")); // Consider changing this to Date if dob is a date in DB
